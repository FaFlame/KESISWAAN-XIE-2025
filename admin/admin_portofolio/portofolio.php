...
<head>
	...
	<style>
		...
		.form-action-row {
			/* place actions visually separated at the bottom of the form */
			display: flex;
	...
	<div class="main-content">
		...
		<div class="content-wrapper">
			...
			<div class="card-form">
				...
				<textarea id="deskripsi" name="deskripsi" placeholder="Deskripsi Singkat Kegiatan Lomba" rows="5" style="resize:vertical;"></textarea>
