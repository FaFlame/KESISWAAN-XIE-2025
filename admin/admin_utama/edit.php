...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudfla	re.com/ajax/libs/font-awesome/5.15.4/css/all.min.css">
	<style>
		:root {
			--sidebar-bg: #fff;
...
<body>
    ...
    <div class="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <div class="nav-item"><a href="#"><i class="fas fa-trophy" style="margin-right: 10px;"></i> Prestasi</a></div>
            <div class="nav-item"><a href="#"><i class="fas fa-calendar-alt" style="margin-right: 10px;"></i> Ekskul</a></div>
