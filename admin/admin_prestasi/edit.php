...
<head>
	...
	<title>Edit - Admin Prestasi</title>
        ...
        <div class="sidebar-header">
            <div class="profile">
                ...
                <div class="profile-info">
                    <h3>M. AUFA RAHMAN</h3>
                    <p><img src="/img/location-dot-solid-full (1).svg" alt="" class="location-icon" style="width:12px;height:12px;filter:invert(1);"> Admin Prestasi</p>
                </div>
            </div>
        </div>
        <nav class="sidebar-nav">
            <div class="nav-item"><a href="#"><i class="fas fa-home" style="margin-right: 10px;"></i> Home</a></div>
            <div class="nav-item active"><a href=""><i class="fas fa-trophy" style="margin-right: 10px;"></i> Prestasi</a></div>
