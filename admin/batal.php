...
<head> 
    ...
    <title>Cancelled Checkout | Doughlicious</title> 
...
<body> 
    <div class="wrapper"> 
        ...
        <div class="section"> 
            <h2 class="card-title">Cancelled Checkouts (Invalid Payment Proof)</h2> 
            <table class="table1"> 
                <tr> 
                    <th>No</th> 
                    <th>Product Name</th> 
                ...
                <?php 
                    ...
                    echo '<tr><td colspan="11" style="text-align:center;">No cancelled checkout data found</td></tr>';
                }
                ?> 
            </table> 
        </div> 
